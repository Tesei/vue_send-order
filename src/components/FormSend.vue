<template>
    ...
    <div class="form__row flex flex-row flex-wrap justify-end items-end" @keyup="checkValid">
        <my-input :nameId="1" :req="true" :clickButton="clickButton" :placeHolder="placeHolders[0]"
            :data-error="dataError[0]" :typeInput="'text'"
            class="flex-auto mb-5 sm:pr-7 md:pr-5 basis-full sm:basis-2/6 md:basis-1/4" v-model.trim="insertedData.name"
